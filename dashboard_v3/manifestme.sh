...
#   ./dashboard_v3/manifestme.sh
#   cd dashboard_v3 && ./manifestme.sh
#
...
#   OPENAI_API_KEY      — required for “Generate AI briefing” (multi-agent pipeline)
#   OPENAI_MODEL        — optional override of the default OpenAI model id
#
# To target a specific Python version on the server (optional), add for example:
#   --override-python-version 3.10
